    ...
    <main>
        <section>
            <article>
                ...
                <p>Your order at {{ $foodTruckName }} has been placed and is awaiting approval. Once they approve the order, you will receive an updated email confirming their acceptance. This will also be updated on the site and via SMS if you have implemented that functionality.</p>
                <p>Thank you for using SnackHound!</p>
